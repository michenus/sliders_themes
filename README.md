...
<h1>Модуль слайдера для Drupal 7. Версия 1.0</h1>
...
<ul style="padding-left:15px">
  	 ...
  	 <li> <b>render_img</b> - полная картинка с изображением (с применением стиля)</li>
</ul>
Пример: <b>$element[1]['render_img']</b> - содержит первое изображение слайдера, уже готовое для вывода.<br>
<b>P.S.: Счёт идёт с 1-цы.</b>

<h2> Дальнейшие изменения </h2>
<ol>
<li>Стиль по умолчанию создается нужный</li>
<li>Изображения можно будет менять местами</li>
<li>Для работы со слайдером будет создана отдельная таблица в БД, во время удаления модуля - таблица будет удаляться.</li>
</ol>
